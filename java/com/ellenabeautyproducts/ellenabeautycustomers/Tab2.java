...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)rootView.findViewById(R.id.recyclerViewDisapproved);
    ...
    private void loadRecyclerView()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.DISAPPROVED_ORDERS, new Response.Listener<String>() {
            @Override
